...
#PBS -o ./exps/nscclog/nscc_output_s3.log
...
python main.py --config="./configs/foster_caf22ft1k_384_cs701_lr1e-3+20_lr1e-3+30_mpc25_bs16.json" --config_id="foster_caf22ft1k_384_cs701_lr1e-3+20_lr1e-3+30_mpc25_bs16"