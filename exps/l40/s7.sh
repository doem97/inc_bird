...
export CUDA_VISIBLE_DEVICES="3"
# python main.py \
#     --config "./configs/foster_cs701_lr1e-3_mem300_im21k.json" \
#     --config_id "foster_cs701_lr1e-3_mem300_im21k"
...
python main.py --config="./configs/foster_cs701_lr1e-3_mem2000_mpc20_bs16_25e_im21k.json" --config_id="foster_cs701_lr1e-3_mem2000_mpc20_bs16_25e_im21k"